...
Instead of calling `Elm.fullscreen` or `Elm.embed`, compiled modules now expose their own functions for starting an app in HTML. These functions still return an instance exposing the ports into and out of your app.

```javascript
// 0.16
var app = Elm.fullscreen(Elm.Main);
var app = Elm.embed(Elm.main, document.querySelector('#main'));
app.ports.something.subscribe(function () { });
